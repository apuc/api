                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Подписчики в группу</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> Репосты</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> Лайки</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> Опросы</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
