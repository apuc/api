<?php
    ...
    class VKApi
    {
        ...
        public static function getGroupIdByUrl($groupUrl)
        {
            ...
            $group = json_decode(file_get_contents('https://api.vk.com/method/groups.getById?v=5.37&group_id=' . $groupName), true);
        ...
        public static function getWallPosts($id){
            $wall = json_decode(file_get_contents('https://api.vk.com/method/wall.get?v=5.37&count=100&filter=owner&owner_id=-' . $id), true);
