...
class OrderSearch extends Order
{
    ...
    {
        return [
            [['id', 'user_id', 'service_id', 'date', 'status', 'kind', 'members_count', 'cost', 'sex', 'age_min', 'age_max', 'friends_count', 'country', 'city', 'minute_1', 'minutes_5', 'hour_1', 'hours_4', 'day_1'], 'integer'],
